<x-layout>
    <x-slot name="tittle">Beranda</x-slot>
    <div class="content-home hijau font-putih">
        <div class="summer">
            <div class="list">
                <div class="foto">
                    <img src="{{ \Illuminate\Support\Facades\URL::asset('/Images/137-78883.webp') }}" alt="foto-summer"/>
                </div>
            </div>
            <div class="list">
                <div class=" desc">
    ...
    <div class="content-home merah font-putih">
        <div class="summer">
            ...
            <div class="list">
                <div class="foto">
                    <img src="{{ \Illuminate\Support\Facades\URL::asset('/Images/137-78943.jpg') }}" alt="foto-summer"/>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="content-home pink">
        <div class="summer">
            <div class="list">
                <div class="foto">
                    <img src="{{ \Illuminate\Support\Facades\URL::asset('/Images/137-78945.jpg') }}" alt="foto-summer"/>
                </div>
            </div>
            <div class="list">
                <div class=" desc">
    ...
    <div class="content-home ijo font-putih">
        <div class="summer">
            ...
            <div class="list">
                <div class="foto">
                    <img src="{{ \Illuminate\Support\Facades\URL::asset('/Images/137-78799.jpg') }}" alt="foto-summer"/>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="content-home turkuis">
        <div class="summer">
            <div class="list">
                <div class="foto">
                    <img src="{{ \Illuminate\Support\Facades\URL::asset('/Images/137-78800.webp') }}" alt="foto-summer"/>
                </div>
            </div>
            <div class="list">
                <div class=" desc">
        ...
        <div class="summer">
            <div class="list">
                ...
                <div class="left cream">
                    <div class="foto">
                        <img src="{{ \Illuminate\Support\Facades\URL::asset('/Images/card-and-stars.jpg') }}" alt="foto-summer"/>
                    </div>
            ...
            <div class="list">
                <div class="reward">
                    <div class="right cream">
                        <div class="foto">
                            <img src="{{ \Illuminate\Support\Facades\URL::asset('/Images/phone-and-stars.jpg') }}" alt="foto-summer"/>
                        </div>
