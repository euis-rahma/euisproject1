<html>
<head>
    <title><?php echo e($tittle ?? 'ini default tittle'); ?></title>
    <link href="<?php echo e(\Illuminate\Support\Facades\URL::asset('/css/app.css')); ?>" rel="stylesheet" />
    <link href="<?php echo e(\Illuminate\Support\Facades\URL::asset('/fontawesome6/css/all.css')); ?>" rel="stylesheet" />
    <link href="https://db.onlinewebfonts.com/c/8d223b3ad8d4819e9dcf22757e4cc2c4?family=Arial" rel="stylesheet" type="text/css"/> 
 ...
 <header>
        <ul class="kiri">
            ...
            <li><a href="<?php echo e(route('site.index')); ?>">Menu</a></li>
            <li><a href="<?php echo e(route('site.index')); ?>">Rewards</a></li>
            <li><a href="<?php echo e(route('site.index')); ?>">Gift Cards</a></li>
        </ul>
        <ul class="kanan">
            <li><a href="<?php echo e(route('site.index')); ?>">Find a store</a></li>
            <li><a href="<?php echo e(route('site.index')); ?>" class="sign-in">Sign in</a></li>
            <li><a href="<?php echo e(route('site.index')); ?>" class="join">Join now</a></li>
        </ul>
    </header>
    <main id="content">
        <?php echo e($slot); ?>
    ...
    <footer>
        <div class="footer-l2">
            <div class="sitemap">
                ...
                <div class="list">
                    ...
                    <ul>
                        ...
                        <li><a href="#">Environmental and Social Impact</a></li>
            ...
            <ul class="taehyungganteng">
                <li><a href="#">Privacy Policy</a></li>
                <li><a href="#">Terms of Use</a></li>
                <li><a href="#">CA Supply Chai Art</a></li>
                <li><a href="#">Cookie Preferences</a></li>
            </ul>
            <div class="copyrights">
                @2022  Euis Rahmawati - Clone Website starbucks.com, References Reza Ola Yt Channel
            </div>
        </div>
    </footer>
</body>
</html><?php /**PATH C:\xamppbaru\htdocs\replikas_starbuck\resources\views/components/layout.blade.php ENDPATH**/ ?>